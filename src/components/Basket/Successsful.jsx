  ...
  return (
    reduce.successful && (
      ...
      >
        ...
        <div
          className="w-[calc(100%-40px)] max-w-[600px] mx-auto absolute top-1/4 left-0 right-0  pt-5 rounded-[10px]  font-IrSans z-60 bg-white  "
          onClick={() => dispach({ type: "successful" })}
        >
          ...
          <div className="w-11/12 mx-auto  py-6">
            ...
            <h1 className="pt-4 ">
              لطفا هنگام تحویل کالا کد{" "}
              <span className="text-red-600">1245</span> را به مامور تحویل ارائه
              دهید
            </h1>
          </div>
        </div>
