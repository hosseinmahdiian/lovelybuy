    ...
    reduce.Info && (
      <div className="bg-white h-full border">
        ...
        <div className="bg-[#F6F6F6] h-full pt-2 px-2">
          <div className="relative bg-white rounded-t-2xl  my-2  h-[250px] overflow-hidden">
            <span
            ...
            <div className="mx-auto  w-fit">
              <img src={noImage} alt="" className="mt-2" />
            </div>
          </div>

          <div className="h-[calc(100%-450px)] overflow-hidden rounded-b-2xl  mb-32">
            ...
            <div className="h-full ">
              <div className="bg-white mt-1 h-full  px-4">
