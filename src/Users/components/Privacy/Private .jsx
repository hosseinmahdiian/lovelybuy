  ...
  return (
    <div className="  max-w-3xl  mx-auto">
      <div className=" mt-5  mx-auto   ">
        <NavLink to="/" className="flex  item-center align-middle gap-2  ">
        ...
        <div className=" mt-8">
          ...
          <div className="mt-8">
            ...
            <p className="mt-4">
              ...
              ثبت‌نام یا خرید) . اطلاعات مربوط به خریدهای شما (محصولات خریداری
              شده، تاریخ خرید، آدرس ارسال) . اطلاعات مربوط به تعامل شما با
              وبسایت (صفحات بازدید شده، کلیک‌ها)
            </p>
          </div>
          <div className="mt-8">
          ...
          <div className="mt-8">
            ...
            <p className="mt-4">
              ...
              ویرایش کنید یا درخواست حذف‌شان را بدهید. برای اطلاعات دقیق‌تر،
                لطفا به  <NavLink className="font-bold text-blue-500 px-1">شرایط و قوانین استفاده</NavLink> مراجعه کنید.
            </p>
          </div>
        </div>
      </div>
