    ...
    <div className="relative max-h-screen min-h-screen max-w-2xl mx-auto">
      <div className="flex items-center mt-3   mx-2 gap-2">
        <div className="relative   w-[calc(100%-66px)]  ">
          <input
            className="peer border px-5 border-black border-opacity-5 rounded-[10px] outline-gray-300 h-14 w-full "
            placeholder=" "
            type="text"
            name="search"
            id="search"
        ...
        <NavLink className="border border-black border-opacity-5 rounded-[10px] bg-white h-14 w-14 text-center pt-2 text-2xl font-bold ">
          <FiMaximize className="inline text-gray-600 mt-1 text-center" />
        </NavLink>
      </div>
